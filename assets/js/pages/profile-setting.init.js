...
if (document.querySelector("#profile-img-file-input")) {
    document.querySelector("#profile-img-file-input").addEventListener("change", function () {
        ...
        if (file) {
            ...
            //var name = id.replaceAll(".", "");

            var formData = new FormData();
            formData.append("profile-img-file-input", file);

            // Kirim formData ke server menggunakan AJAX
            var xhr = new XMLHttpRequest();
            xhr.open("POST", "assets/api/process.php?action=uploadImage&id="+id, true);
