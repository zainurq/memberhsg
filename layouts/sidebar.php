    ...
    <div id="scrollbar">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="redeem.php">
                        <i class="ri-exchange-line"></i> <span data-key="t-widgets">Tukar</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarApps" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarApps">
                        <i class="ri-apps-2-line"></i> <span>Riwayat Transaksi</span>
                    </a>
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="profile.php">
                        <i class="ri-shield-user-line"></i> <span data-key="t-widgets">Profil</span>
                    </a>
                </li>
            </ul>
        </div>
