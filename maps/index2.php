    ...
    <style>
       ...
       .marker-label {
        ...
        .current-location-label {
            ...
            position: absolute;
            pointer-events: none;
            transform: translate(-35%, -295%); /* Mengubah nilai ini agar label berada di atas marker */
            z-index: 1; /* Memastikan label di atas marker */
        }
        ...
        /* Sembunyikan Mapbox Directions pada perangkat seluler */
        @media (max-width: 767px) {
...
<body>
    <div id="header">
        ...
        <div class="mb-4" style="text-align:center;">
            <label for="storeSearch" class="form-label">Search:</label>
            <input type="text" class="form-control" id="storeSearch" oninput="searchStores()">
        </div>
        <!-- Tampilkan total jumlah toko -->
        <div class="mb-4" style="text-align:right;">
            <b><p>Total Store: <span id="totalStores">0</span></p></b>
        </div>
    </div>
