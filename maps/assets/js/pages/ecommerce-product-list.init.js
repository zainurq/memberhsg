			...
			},
			{
				...
				data: (function (row) {
					return gridjs.html('<div class="d-flex align-items-center">' +
						...
						'<h5 class="fs-14 mb-1"><a href="apps-ecommerce-product-details.php" class="text-body">' + row.product.title + '</a></h5>' +
			...
			},
			{
				...
				formatter: (function (cell, row) {
					...
					return gridjs.html('<div class="dropdown">' +
						...
						'<li><a class="dropdown-item edit-list" data-edit-id=' + x + ' href="apps-ecommerce-add-product.php"><i class="ri-pencil-fill align-bottom me-2 text-muted"></i> Edit</a></li>' +
