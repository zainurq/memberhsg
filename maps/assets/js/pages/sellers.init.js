    ...
    for (var i = (page - 1) * itemsPerPage; i < (page * itemsPerPage) && i < datas.length; i++) {
        ...
        <div class="card ribbon-box right overflow-hidden">\
            <div class="card-body text-center p-4">\
                ...
                <h5 class="mb-1 mt-4"><a href="apps-ecommerce-seller-details.php" class="link-primary">'+ datas[i].shop[0].name + '</a></h5>\
                ...
                <div class="mt-4">\
                    <a href="apps-ecommerce-seller-details.php" class="btn btn-light w-100">View Details</a>\
                </div>\
            </div>\
        </div>\
    </div>';
